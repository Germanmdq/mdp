    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-2">
          {categories.map((cat) => (
            <button
              ...
              className={`flex items-center justify-between px-3 py-2 text-sm rounded-2xl transition-all ${
      ...
      <div>
        ...
        <button
          ...
          className={`flex w-full items-center gap-2 px-3 py-3 rounded-2xl border transition-all text-sm font-semibold ${
            currentFeatured 
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input type="number" placeholder="Mínimo" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-3 py-2 text-sm outline-none focus:border-blue-500" />
          <span className="text-slate-300">—</span>
          <input type="number" placeholder="Máximo" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-3 py-2 text-sm outline-none focus:border-blue-500" />
        </div>
      </div>

      {/* Clear Button */}
      {(currentCategory || currentQ || currentFeatured) && (
        <button onClick={clearAll} className="w-full py-3 text-xs font-bold text-red-500 hover:bg-red-50 rounded-2xl border border-transparent transition-all">
